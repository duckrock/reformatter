...
###################################################################################################################
def HTMLToTextFunc(ChordURL,WebSongTitle):
...
def reformatterfunc(songlist,WebSongTitle):
    #----------------------------------------------------
...
# ChordURL =
# dev hardcode--------------------------------------------------------------------------
#HTMLGetWebSongTitle(ChordURL,WebSongTitle)
HTMLToTextFunc(ChordURL,WebSongTitle)
exec(open('FileToListOfLists.py').read())
reformatterfunc(songlist,WebSongTitle)
