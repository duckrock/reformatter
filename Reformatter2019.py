...
def main():
   ...
   ## For PC - LinePrepender(os.path.join(os.path.expanduser('~'), 'Documents\\GitHub\\reformatter\\Songs', NewFileName), WebSongTitle)
    LinePrepender(os.path.join(os.path.expanduser('~'), 'PycharmProjects/Reformatter/Songs', NewFileName),
                  WebSongTitle)
...
def ReformatterFunc(SongList,WebSongTitle,ChordURL):
   ...
   ## For PC - file=open(os.path.join(os.path.expanduser('~'), 'Documents\\GitHub\\reformatter\\Songs', NewFileName),"w") # Open a file for output called the truncated name of the song
